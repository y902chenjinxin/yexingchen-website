...
_HTTP_STATUS_BY_CODE = {
    ...
    ErrCode.INTERNAL_ERROR[0]: status.HTTP_500_INTERNAL_SERVER_ERROR,
    ErrCode.AUTH_INVALID_TOKEN[0]: status.HTTP_401_UNAUTHORIZED,
    ErrCode.AUTH_USER_NOT_EXIST[0]: status.HTTP_404_NOT_FOUND,
    ErrCode.AUTH_USER_STATUS_INVALID[0]: status.HTTP_401_UNAUTHORIZED,
    ErrCode.AUTH_INVALID_CREDENTIALS[0]: status.HTTP_401_UNAUTHORIZED,
    ErrCode.AUTH_RATE_LIMITED[0]: status.HTTP_429_TOO_MANY_REQUESTS,
    ErrCode.AUTH_PERMISSION_DENIED[0]: status.HTTP_403_FORBIDDEN,
    ErrCode.REG_EMAIL_EXISTS[0]: status.HTTP_400_BAD_REQUEST,
    ErrCode.REG_CODE_EXPIRED[0]: status.HTTP_400_BAD_REQUEST,
    ErrCode.REG_CODE_INVALID[0]: status.HTTP_400_BAD_REQUEST,
    ErrCode.REG_CODE_EXCEED_ATTEMPTS[0]: status.HTTP_400_BAD_REQUEST,
    ErrCode.REG_CODE_NOT_REQUESTED[0]: status.HTTP_400_BAD_REQUEST,
    ErrCode.REG_PENDING[0]: status.HTTP_400_BAD_REQUEST,
    ...
    ErrCode.NOVEL_NOT_FOUND[0]: status.HTTP_404_NOT_FOUND,
    ErrCode.NOVEL_UPLOAD_FAILED[0]: status.HTTP_500_INTERNAL_SERVER_ERROR,
    ErrCode.NOVEL_DELETE_FAILED[0]: status.HTTP_500_INTERNAL_SERVER_ERROR,
    ErrCode.VIDEO_NOT_FOUND[0]: status.HTTP_404_NOT_FOUND,
    ErrCode.VIDEO_UPLOAD_FAILED[0]: status.HTTP_500_INTERNAL_SERVER_ERROR,
    ErrCode.VIDEO_DELETE_FAILED[0]: status.HTTP_500_INTERNAL_SERVER_ERROR,
    ErrCode.TOOL_NOT_FOUND[0]: status.HTTP_404_NOT_FOUND,
    ErrCode.TOOL_CREATE_FAILED[0]: status.HTTP_500_INTERNAL_SERVER_ERROR,
    ErrCode.TOOL_UPDATE_FAILED[0]: status.HTTP_500_INTERNAL_SERVER_ERROR,
    ErrCode.TOOL_DELETE_FAILED[0]: status.HTTP_500_INTERNAL_SERVER_ERROR,
    ErrCode.SYS_DATABASE_ERROR[0]: status.HTTP_500_INTERNAL_SERVER_ERROR,
    ErrCode.SYS_FILE_NOT_FOUND[0]: status.HTTP_404_NOT_FOUND,
    ErrCode.SYS_UPLOAD_FAILED[0]: status.HTTP_500_INTERNAL_SERVER_ERROR,
}


def get_http_status(code: int) -> int:
    """根据业务错误码返回对应 HTTP 状态。"""
    return _HTTP_STATUS_BY_CODE.get(code, status.HTTP_500_INTERNAL_SERVER_ERROR)
