...
.fd-input:focus { border-color: var(--lj-seal); }
...
.fd-source-item.active { background: rgba(127,168,163,.12); border-color: var(--lj-seal); }
...
.fd-op:hover { color: var(--lj-seal); background: rgba(127,168,163,.1); }
...
.fd-r-meta { margin-top: 9px; font-size: 12px; color: var(--lj-text-3); }
...
.fd-reader-body { display: flex; flex-direction: column; gap: 16px; }
.fd-hero { width: 100%; max-height: 340px; object-fit: cover; border-radius: 14px; border: 1px solid var(--lj-line);
  box-shadow: var(--glass-highlight); }
.fd-body-sum { margin: 0; font-size: 14px; line-height: 1.75; color: var(--lj-text-2);
  border-left: 3px solid var(--lj-dai); padding: 2px 0 2px 14px; text-align: justify; }
.fd-body { margin: 0; font-size: 15px; line-height: 1.95; white-space: pre-wrap; word-break: break-word; text-align: justify; }
/* 富文本正文（服务端白名单清洗后渲染） */
.fd-rich { font-size: 15px; line-height: 1.95; word-break: break-word; text-align: justify; }
